...
class TokenEmbedding(nn.Embedding):
    ...
    def __init__(self: Any, vocab_size: int, pad_id: int, d_model: int) -> None:
        """constructor
        ...
        @return: None
        """
        super(TokenEmbedding, self).__init__(vocab_size, d_model, padding_idx=pad_id)
...
class TransformerEmbedding(nn.Module):
    ...
    def __init__(self: Any, vocab_size: int, max_seq_len: int, pad_id: int,
        ...
        self.token_embedding: TokenEmbedding = TokenEmbedding(vocab_size=vocab_size, pad_id=pad_id, d_model=d_model)
